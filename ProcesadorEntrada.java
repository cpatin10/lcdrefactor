...
public class ProcesadorEntrada {
     ...
     */
    private void procesarEspacioDígitos(Scanner lector) 
     ...
     */
    private void verificarEspacios() throws IllegalArgumentException{
     ...
     */
    private String[] separarComando(String comando) throws IllegalArgumentException{  
     ...
     */
    private void validarCantidadParametros(int cantidadDada, String entrada) 
    		throws IllegalArgumentException {
     ...
     * @return
     */
    private boolean sizeValido(int size) {
